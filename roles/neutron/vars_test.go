...
func TestHelmValues(t *testing.T) {
	...
	vars.HelmValues.Pod.PriorityClass = map[string]string{
		...
		"neutron_ovn_maintenance_worker": "high-priority",
		"neutron_periodic_worker": "high-priority",
	...
	vars.HelmValues.Pod.RuntimeClass = map[string]string{
		...
		"neutron_ovn_maintenance_worker": "kata-clh",
		"neutron_periodic_worker": "kata-clh",
