...
And you can also override specifc alerts groups if you needs:
...
If you wish to simply override all existing rules groups, you can directly change above example with:
