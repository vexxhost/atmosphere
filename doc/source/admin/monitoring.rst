...
2. Ensure that you select "AlertManager" on the top right corner of the page,
   ...
   .. admonition:: AlertManager selection
    ...
    Prometheus operator, otherwise your silence wont be applied to the
...
If you want to whitelist specific IP to access the Prometheus UI, you can do
...
Afterwards, you can configure the following options for the Atmosphere,
