...
target "neutron-source" {
    ...
    contexts = {
        "git" = "https://opendev.org/openstack/neutron.git#224cb635d141f282e451f4084c12ddc096c6a8fc" # renovate: branch=master
...
target "networking-generic-switch-source" {
    ...
    contexts = {
        "git" = "https://opendev.org/openstack/networking-generic-switch.git#c471cad183a1f360f12e8490a566d79d14ca38eb" # renovate: branch=master
