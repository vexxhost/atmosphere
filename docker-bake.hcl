...
target "kubernetes-entrypoint" {
    ...
    tags = [
        "${REGISTRY}/kubernetes-entrypoint:${RELEASE}"
    ]
}
...
target "ovn" {
    ...
    tags = [
        "${REGISTRY}/ovn-${component}:${RELEASE}"
    ]
}
...
target "python-openstackclient" {
    ...
    tags = [
        "${REGISTRY}/python-openstackclient:${RELEASE}"
    ]
}
